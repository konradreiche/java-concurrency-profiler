...
void protobuf_AssignDesc_AgentMessage_2eproto() {
  ...
  static const int AgentMessage_Threads_Thread_offsets_[4] = {
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_isContextClassLoaderSet;
        break;
      }
...
void AgentMessage_Threads_Thread::SerializeWithCachedSizes(
  ...
  if (has_iscontextclassloaderset()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(4, this->iscontextclassloaderset(), output);
  }
...
::google::protobuf::uint8* AgentMessage_Threads_Thread::SerializeWithCachedSizesToArray(
  ...
  // required bool isContextClassLoaderSet = 4;
  if (has_iscontextclassloaderset()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(4, this->iscontextclassloaderset(), target);
  }
